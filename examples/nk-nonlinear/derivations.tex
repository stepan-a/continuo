...
\item Code implementing these models is available in the \texttt{examples/nk-nonlinear/} directory of the \href{https://github.com/stepan-a/continuo}{Continuo} repository.
